                        ...
                        <Col className='col-lg-4 col-md-6 col-12'>
                            ...
                            <ul className='socialIconsList'>
                                ...
                                <li className='linkedin'>
                                    <a rel="noreferrer" href="https://www.linkedin.com/in/irkfaisal/" target="_blank">
                                        <BsLinkedin />
                                    </a>
                                </li>
                                ...
                                <li className='blogGoogle'>
                                    <a rel="noreferrer" href="https://irkfaisal.github.io/faisal_raza_khan/" target="_blank">
                                        <BsGoogle />
                                    </a>
                                </li>
                                <li className='github'>
                                    <a rel="noreferrer" href="https://github.com/irkfaisal/" target="_blank">
                                        <BsGithub />
                                    </a>
                                </li>
                                <li className='ytube'>
                    ...
                    <Row>
                        <Col className='col-12'>
                            <div className="footerCopyright">
                                <small>Developed and Designed  by <a href="https://irkfaisal.github.io/faisal_raza_khan/" target="_blank" rel="noreferrer">Md Faisal Raza Khan</a>.</small>
                            </div>
                        </Col>
                    </Row>
                </Container>
